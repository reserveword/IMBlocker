...
# 7.1.6
 - 兼容 26.2 正式版
 - Windows：补充第一次窗口焦点消息以正确同步输入法的初始状态
 
<br>

# 7.1.5
 - Windows: 使转换状态计时线程在 26.2 下能够正常退出
 - 默认屏幕白名单中的项目现在强制生效以防止误删
 - 屏幕记录开启时现在会在左上角显示当前屏幕的类名以方便对照编辑白名单
...
# 7.0.0-beta.2
 ...
 - 增加 Windows 游戏内输入法实验性功能
 
<br>

# 7.0.0-beta.1
 - 更新至 26.1 正式版并包含部分自定义组件的模组的兼容层
