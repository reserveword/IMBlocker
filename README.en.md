...
**Although vanilla has integrated similar features since 26.1, it has proven to be of low quality and completely unsupported on certain platforms, thus this mod will continue to be maintained.**

## Features (26.1+)

- Virtually precise focus management, only activate IME if it's actually needed
...
- Support basic IME switching and fix non-character keys leaking to the game while candidates showing on macOS/Linux
