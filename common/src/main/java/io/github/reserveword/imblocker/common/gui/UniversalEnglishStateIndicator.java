...
public class UniversalEnglishStateIndicator {
	...
	public static void renderOnMinecraftSurface(GuiGraphics graphics) {
		...
		if(IMBlockerConfig.INSTANCE.isIngameIMEEnabled() &&
			...
			graphics.drawString(Minecraft.getInstance().font, "EN", graphics.guiWidth() - fontSize * 2, graphics.guiHeight() - fontSize * 2, INDICATOR_COLOR, false);
		}
	}
