...
import io.github.reserveword.imblocker.common.jnastructs.XPoint;
...
final class IMManagerX11 extends IMManagerLinux {
	...
	public IMManagerX11() {
		this.glfwWindow = MinecraftClientAccessor.INSTANCE.getWindowHandle();
		this.x11Window = GLFWNativeX11.glfwGetX11Window(glfwWindow);
	...
	private void checkXIC() {
		...
		// scan for x11Window pointer offset
		...
		long candidate = safeReadLong(base, handleOffset + pointerSize * 3);
		// boolean distinguish
